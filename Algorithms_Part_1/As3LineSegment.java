...
public class As3LineSegment {
    private final As3Point p;   // one endpoint of this line segment
    private final As3Point q;   // the other endpoint of this line segment
     ...
     */
    public As3LineSegment(As3Point p, As3Point q) {
        if (p == null || q == null) {
