...
public class As4BoggleBoard {
     ...
     */
    public As4BoggleBoard(String filename) {
     ...
     */
    public As4BoggleBoard(int m, int n) {
        this.m = m;
        this.n = n;
        if (m <= 0) throw new IllegalArgumentException("number of rows must be a positive integer");
        if (n <= 0)
    ...
    public static void main(String[] args) {
        ...
        As4BoggleBoard board1 = new As4BoggleBoard();
        ...
        As4BoggleBoard board2 = new As4BoggleBoard(4, 4);
        ...
        As4BoggleBoard board3 = new As4BoggleBoard(a);
        ...
        As4BoggleBoard board4 = new As4BoggleBoard(filename);
